...
public class ContactUsWebservice extends AsyncTask<Void, Void, Void> {
	...
	public ContactUsWebservice(String strUrl,String strEntity, CustodianInterface mListener,

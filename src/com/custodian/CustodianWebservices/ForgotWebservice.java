...
import android.util.Log;
	...
	public class ForgotWebservice extends AsyncTask<Void, Void, Void> {
		
		String strUrl ="";
		String strEntity;
		ForgotInterface gListener;
		String response = "";
		...
		public ForgotWebservice(String strUrl,String strEntity, ForgotInterface mListener,

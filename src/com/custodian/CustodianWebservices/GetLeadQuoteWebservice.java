...
public class GetLeadQuoteWebservice extends AsyncTask<Void, Void, Void> {
	...
	public GetLeadQuoteWebservice(String strUrl, String strEntity, CustodianInterface mListener,

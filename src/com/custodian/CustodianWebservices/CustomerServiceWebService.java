...
public class CustomerServiceWebService extends AsyncTask<Void, Void, Void> {
	
	String strUrl ="";
	String strEntity;
	CustomerService gListener;
	String response = "";
	...
	public CustomerServiceWebService(String strUrl, CustomerService mListener,
			Context gContext, boolean isDialog,String Message) {
	...
	protected void onPostExecute(Void result) {
		...
		if (!response.equalsIgnoreCase("") && response != null) {
			gListener.onResponsePayment(response);

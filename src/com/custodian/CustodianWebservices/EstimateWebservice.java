...
public class EstimateWebservice extends AsyncTask<Void, Void, Void> {
	
	String strUrl ="";
	String strEntity;
	EstimateInterface gListener;
	String response = "";
	...
	public EstimateWebservice(String strUrl, EstimateInterface mListener,
			Context gContext, boolean isDialog) {
	...
	protected void onPreExecute() {
		...
		super.onPreExecute();
		if (isDialog == true) {
			mDialog = ProgressDialog.show(gContext, "Loading Locations...", "");
		}
	...
	protected void onPostExecute(Void result) {
		...
		if (!response.equalsIgnoreCase("") && response != null) {
			gListener.onGetResult(response);
